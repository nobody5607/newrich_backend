    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                ?>
                <div class="form-group field-profile-sitecode">
                    <label class="col-lg-3 control-label" for="profile-sitecode"><?= Yii::t('app','Sitecode')?></label>
                    <div class="col-lg-9"><label><?= \common\modules\user\classes\CNUserFunc::getSitecode()?> </label></div>
