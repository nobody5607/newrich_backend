...
function upli_poll(n, t) {
    var i;
    i = "postprocess=" + n + "&fname=" + t;
    upli_curData == null && (i = i + "&canceled=true");
    i = "/BVModules/Controls/DesignerImageUpload.ashx?" + encodeURI(i);
    $.ajax({
        url: i,
        cache: !1,
        success: function(n) {
        ...
        complete: function(i, r) {
            ...
            u != undefined && u[0] == "<" && (u = '{ "finished": 1, "resultMessage": "There was an unexpected error, please try again" }');
            u == "" || u != undefined && r != "error" && r != "abort" && JSON.parse(u).finished != "1" ? upli_poll(n, t) : window.setTimeout(function() {
                upli_endpostprocess(JSON.parse(u))
            }, 400)
        },
        timeout: 45e3,
        async: !0
...
function upli_startpostprocess(n, t) {
    bPostProcess = !0;
    $("#upli_container .progress-bar").css("width", "100%");
    $("#upli_container .progress-bar span").text("Processing...");
    upli_poll(n, t);
    setTimeout(function() {
        upli_updatecontrol()
    }, 50)
...
function upli_endpostprocess(n) {
    window.onbeforeunload === upli_onbeforeupload && (window.onbeforeunload = upli_oldBeforeUnload);
    $("#upli_container .progress-bar span").text("");
    $("#upli_container").hide();
    $("#upli_progress").hide();
    upli_curData = null;
    bPostProcess = !1;
    $("#upli_btn").removeClass().addClass("button clean fileinput-button");
    $("#upli_btn_text").text(upli_btn_idle_text);
    upliFinishedCallback != undefined && upliFinishedCallback(n)
}

function upli_fail(n, t, i) {
    upli_curData == null ? ($("#upli_container .progress-bar span").text("Upload canceled"), upli_poll(i, t.originalFiles[0].name)) : ($("#upli_container .progress-bar span").text("Upload failed"), upli_curData = null, upli_updatecontrol());
    $("#upli_btn").removeClass().addClass("button clean fileinput-button");
    $("#upli_btn_text").text(upli_btn_idle_text);
    bPostProcess = !1
}

function upli_progress(n) {
    var t = parseInt(n.loaded / n.total * 100, 10);
    $("#upli_container .progress-bar").css("width", t + "%");
    n.msg == undefined ? $("#upli_container .progress-bar span").text("Uploading File, " + t + "% complete") : $("#upli_container .progress-bar span").text(n.msg)
}

function upli_onbeforeupload() {
    return "If you leave or refresh this page your upload will be canceled. Are you sure?"
}

function upli_cancel(n) {
    if (n = n && n != undefined ? n : window.event, n != null && n != undefined && n.preventDefault != undefined && n.preventDefault(), upli_curData != null && confirm("Are you sure you want to cancel the upload?")) {
        var t = upli_curData;
        upli_curData = null;
        t.abort();
        $("#upli_btn_text").text("Canceling...");
        bPostProcess && upli_fail(null, t, upli_id)
    }
}

function InitJqup() {
    "use strict";
    var n = "/BVModules/Controls/DesignerImageUpload.ashx?fileProcess=" + encodeURI(upli_id);
    window.onbeforeunload === upli_onbeforeupload && (window.onbeforeunload = upli_oldBeforeUnload);
    $("#upli_container").hide();
    $("#upli_btn").removeClass().addClass("button clean fileinput-button");
    $("#upli_btn_text").text(upli_btn_idle_text);
    ...
    $("#fileupload").fileupload({
        ...
        maxNumberOfFiles: 1,
            ...
            window.setTimeout(function() {
                upli_startpostprocess(upli_id, t.originalFiles[0].name)
            }, 150)
        },
        fail: function(n, t) {
            upli_fail(n, t, upli_id)
        },
        abort: function(n, t) {
            upli_fail(n, t, upli_id)
        },
        ...
        submit: function(n, t) {
            upli_curData = t;
            $("#upli_btn").removeClass().addClass("button clean secondary fileinput-button");
            $("#upli_btn_text").text("Cancel...");
            upli_oldBeforeUnload = window.onbeforeunload;
            window.onbeforeunload = upli_onbeforeupload;
            $("#upli_container .progress-bar span").text("Uploading File, 0% complete");
            $("#upli_container").show();
            $("#upli_progress").show()
        }
...
function AddToCart(n, t, i, r, u, f, e, o, s, h, c) {
    var l = '{"userID": ' + JSON.stringify(n) + ',"svgTemplate":' + JSON.stringify(t) + ',"quantity": ' + JSON.stringify(i) + ', "productId": ' + JSON.stringify(r) + ',"inkColor": ' + JSON.stringify(u) + ', "priceOffset": ' + JSON.stringify(f) + ',"parentDesignId": ' + JSON.stringify(e) + ', "itemId": ' + JSON.stringify(o) + ', "itemIdType": ' + JSON.stringify(s) + "}";
    $.ajax({
        type: "POST",
        url: "/DesignerServices.asmx/AddToCart",
        data: l,
...
function GetItemMatchingBodies(n, t, i, r) {
    ...
    $.ajax({
        type: "POST",
        url: "/DesignerServices.asmx/GetItemMatchingBodies",
        data: u,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function(n) {
...
function GetWizardURL(n, t, i) {
    ...
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/GetWizardURL",
        data: r,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: t,
...
function GetProductURL(n, t, i) {
    ...
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/GetProductURL",
        data: r,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: t,
...
function ResetSetupInfo(n, t) {
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/ResetSetupInfo",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: n,
...
function SaveUserDesign(n, t, i, r, u, f, e, o) {
    var s = '{"userID": ' + JSON.stringify(n) + ',"name":' + JSON.stringify(t) + ',"parentDesignId": ' + JSON.stringify(i) + ', "productId": ' + JSON.stringify(u) + ',"inkColor": ' + JSON.stringify(f) + ',"svgTemplate":' + JSON.stringify(r) + "}";
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/SaveUserDesign",
        data: s,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: e,
...
function GetProof(n, t, i, r) {
    var u = '{"svgTemplate":' + JSON.stringify(t) + ',"id":' + JSON.stringify(n) + "}";
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/GetProof",
        data: u,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: i,
...
function CheckUserDesignName(n, t, i) {
    var r = '{"userID": ' + JSON.stringify(n) + ',"name":' + JSON.stringify(t) + "}";
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/CheckUserDesignName",
        data: r,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: i,
...
function GetClipartCategories(n, t) {
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/GetClipartCategories",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: n,
...
function GetClipartFromCategory(n, t, i, r) {
    ...
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/GetClipartFromCategory",
        data: u,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: i,
...
function GetUserLibraryImages(n, t, i, r) {
    var u = '{"userID": ' + JSON.stringify(n) + ',"hostBase":' + JSON.stringify(t) + "}";
    $.ajax({
        type: "POST",
        url: dapiRoot + "/DesignerServices.asmx/GetUserLibraryImages",
        data: u,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: i,
...
function bvLoginChange(n) {
    updateLoginControls();
    n == 1 && (loginReturn != 0 && $(".close-reveal-modal").trigger("click"), loginReturn == 1 ? $("#save-btn").trigger("click") : loginReturn == 2 ? $("#library-link").trigger("click") : loginReturn == 3 && window.location.reload(!0));
    $("#artwork--library").hasClass("active") && updateLibraryImages(!0, {});
    loginReturn = 0
}
        ...
        if (i.async) {
            ...
            return {
                send: function(o, s) {
                    ...
                    f = /\?/.test(i.url) ? "&" : "?";
                    i.type === "DELETE" ? (i.url = i.url + f + "_method=DELETE", i.type = "POST") : i.type === "PUT" ? (i.url = i.url + f + "_method=PUT", i.type = "POST") : i.type === "PATCH" && (i.url = i.url + f + "_method=PATCH", i.type = "POST");
                    t += 1;
                    u = n('<iframe src="' + e + '" name="iframe-transport-' + t + '"><\/iframe>').bind("load", function() {
                        var t, f = n.isArray(i.paramName) ? i.paramName : [i.paramName];
                        ...
                        }), r.append(i.fileInput).prop("enctype", "multipart/form-data").prop("encoding", "multipart/form-data"), i.fileInput.removeAttr("form"));
                        r.submit();
                        t && t.length && i.fileInput.each(function(i, r) {
                            var u = n(t[i]);
                            n(r).prop("name", u.prop("name")).attr("form", u.attr("form"));
                            u.replaceWith(r)
                        })
                    });
    ...
    n.ajaxSetup({
        converters: {
            ...
            "iframe xml": function(t) {
                var i = t && t[0];
                return i && n.isXMLDoc(i) ? i : n.parseXML(i.XMLDocument && i.XMLDocument.xml || n(i.body).html())
            },
...
function(n) {
    ...
    function t(t) {
        ...
        return function(r) {
            ...
            u && n.inArray("Files", u.types) !== -1 && this._trigger(t, n.Event(t, {
                delegatedEvent: r
            })) !== !1 && (r.preventDefault(), i && (u.dropEffect = "copy"))
        }
    }
    n.support.fileInput = !(new RegExp("(Android (1\\.[0156]|2\\.[01]))|(Windows Phone (OS 7|8\\.0))|(XBLWP)|(ZuneWP)|(WPDesktop)|(w(eb)?OSBrowser)|(webOS)|(Kindle/(1\\.0|2\\.[05]|3\\.0))").test(window.navigator.userAgent) || n('<input type="file">').prop("disabled"));
    n.support.xhrFileUpload = !!(window.ProgressEvent && window.FileReader);
    n.support.xhrFormDataFileUpload = !!window.FormData;
    n.support.blobSlice = window.Blob && (Blob.prototype.slice || Blob.prototype.webkitSlice || Blob.prototype.mozSlice);
    n.widget("blueimp.fileupload", {
        options: {
            ...
            i18n: function(t, i) {
                return t = this.messages[t] || t.toString(), i && n.each(i, function(n, i) {
                    t = t.replace("{" + n + "}", i)
                }), t
            },
            formData: function(n) {
            ...
            add: function(t, i) {
                ...
                (i.autoUpload || i.autoUpload !== !1 && n(this).fileupload("option", "autoUpload")) && i.process().done(function() {
                    i.submit()
                })
            },
            processData: !1,
        ...
        _blobSlice: n.support.blobSlice && function() {
        ...
        _BitrateTimer: function() {
            ...
            this.getBitrate = function(n, t, i) {
                ...
                return (!this.bitrate || !i || r > i) && (this.bitrate = (t - this.loaded) * (1e3 / r) * 8, this.loaded = t, this.timestamp = n), this.bitrate
            }
        },
        ...
        _getFormData: function(t) {
            var i;
            return n.type(t.formData) === "function" ? t.formData(t.form) : n.isArray(t.formData) ? t.formData : n.type(t.formData) === "object" ? (i = [], n.each(t.formData, function(n, t) {
                i.push({
                    name: n,
                    value: t
                })
        ...
        _initResponseObject: function(n) {
            var t;
            if (n._response)
                for (t in n._response) n._response.hasOwnProperty(t) && delete n._response[t];
            else n._response = {}
        },
        _onProgress: function(t, i) {
            if (t.lengthComputable) {
                ...
                i._time = r;
                u = Math.floor(t.loaded / t.total * (i.chunkSize || i._progress.total)) + (i.uploadedBytes || 0);
                this._progress.loaded += u - i._progress.loaded;
                this._progress.bitrate = this._bitrateTimer.getBitrate(r, this._progress.loaded, i.bitrateInterval);
                i._progress.loaded = i.loaded = u;
                i._progress.bitrate = i.bitrate = i._bitrateTimer.getBitrate(r, u, i.bitrateInterval);
                this._trigger("progress", n.Event("progress", {
                    delegatedEvent: t
                }), i);
                this._trigger("progressall", n.Event("progressall", {
                    delegatedEvent: t
                }), this._progress)
            }
        },
        ...
        _initXHRData: function(t) {
            ...
            e && !t.blob && this._isInstanceOf("File", r) || (t.headers["Content-Disposition"] = 'attachment; filename="' + encodeURI(r.name) + '"');
            e ? n.support.xhrFormDataFileUpload && (t.postMessage ? (i = this._getFormData(t), t.blob ? i.push({
                name: u,
                value: t.blob
            }) : n.each(t.files, function(r, f) {
                i.push({
                    name: n.type(t.paramName) === "array" && t.paramName[r] || u,
                    value: f
                })
            })) : (f._isInstanceOf("FormData", t.formData) ? i = t.formData : (i = new FormData, n.each(this._getFormData(t), function(n, t) {
                i.append(t.name, t.value)
            })), t.blob ? i.append(u, t.blob, r.name) : n.each(t.files, function(r, e) {
                (f._isInstanceOf("File", e) || f._isInstanceOf("Blob", e)) && i.append(n.type(t.paramName) === "array" && t.paramName[r] || u, e, e.uploadName || e.name)
            })), t.data = i) : (t.contentType = r.type || "application/octet-stream", t.data = t.blob || r);
            t.blob = null
        },
        ...
        _initDataSettings: function(n) {
            this._isXHRUpload(n) ? (this._chunkedUpload(n, !0) || (n.data || this._initXHRData(n), this._initProgressListener(n)), n.postMessage && (n.dataType = "postmessage " + (n.dataType || ""))) : this._initIframeSettings(n)
        },
        _getParamName: function(t) {
            var r = n(t.fileInput),
                i = t.paramName;
            return i ? n.isArray(i) || (i = [i]) : (i = [], r.each(function() {
                for (var t = n(this), u = t.prop("name") || "files[]", r = (t.prop("files") || [1]).length; r;) i.push(u), r -= 1
            }), i.length || (i = [r.prop("name") || "files[]"])), i
        },
        _initFormSettings: function(t) {
            t.form && t.form.length || (t.form = n(t.fileInput.prop("form")), t.form.length || (t.form = n(this.options.fileInput.prop("form"))));
            t.paramName = this._getParamName(t);
            t.url || (t.url = t.form.prop("action") || location.href);
            t.type = (t.type || n.type(t.form.prop("method")) === "string" && t.form.prop("method") || "").toUpperCase();
        ...
        _getDeferredState: function(n) {
            return n.state ? n.state() : n.isResolved() ? "resolved" : n.isRejected() ? "rejected" : "pending"
        },
        ...
        _addConvenienceMethods: function(t, i) {
            ...
            i.process = function(t, f) {
                return (t || f) && (i._processQueue = this._processQueue = (this._processQueue || u([this])).pipe(function() {
                    return i.errorThrown ? n.Deferred().rejectWith(r, [i]).promise() : u(arguments)
                }).pipe(t, f)), this._processQueue || u([this])
            };
            i.submit = function() {
                return this.state() !== "pending" && (i.jqXHR = this.jqXHR = r._trigger("submit", n.Event("submit", {
                    delegatedEvent: t
        ...
        _chunkedUpload: function(t, i) {
            ...
            var u = this,
                ...
                s = o.promise(),
                a, h;
            return !(this._isXHRUpload(t) && l && (r || c < e)) || t.data ? !1 : i ? !0 : r >= e ? (f.error = t.i18n("uploadedBytes"), this._getXHRPromise(!1, t.context, [null, "error", f.error])) : (h = function() {
                var i = n.extend({}, t),
                    s = i._progress.loaded;
                i.blob = l.call(f, r, r + c, f.type);
                i.chunkSize = i.blob.size;
                i.contentRange = "bytes " + r + "-" + (r + i.chunkSize - 1) + "/" + e;
                u._initXHRData(i);
                u._initProgressListener(i);
                a = (u._trigger("chunksend", null, i) !== !1 && n.ajax(i) || u._getXHRPromise(!1, i.context)).done(function(f, c, l) {
                    r = u._getUploadedBytes(l) || r + i.chunkSize;
                    s + i.chunkSize - i._progress.loaded && u._onProgress(n.Event("progress", {
                        lengthComputable: !0,
            ...
            }, this._enhancePromise(s), s.abort = function() {
                return a.abort()
            }, h(), s)
        },
        ...
        _onDone: function(t, i, r, u) {
            var f = u._progress.total,
                e = u._response;
            u._progress.loaded < f && this._onProgress(n.Event("progress", {
                lengthComputable: !0,
                loaded: f,
                total: f
            }), u);
        ...
        _onSend: function(t, i) {
            ...
            var r = this,
                f, s, e, h, u = r._getAJAXSettings(i),
                o = function() {
                    return r._sending += 1, u._bitrateTimer = new r._BitrateTimer, f = f || ((s || r._trigger("send", n.Event("send", {
                        delegatedEvent: t
                    }), u) === !1) && r._getXHRPromise(!1, u.context, s) || r._chunkedUpload(u) || n.ajax(u)).done(function(n, t, i) {
                        r._onDone(n, t, i, u)
                    }).fail(function(n, t, i) {
                        r._onFail(n, t, i, u)
                    }).always(function(n, t, i) {
                        if (r._onAlways(n, t, i, u), r._sending -= 1, r._active -= 1, u.limitConcurrentUploads && u.limitConcurrentUploads > r._sending)
            ...
            return (this._beforeSend(t, u), this.options.sequentialUploads || this.options.limitConcurrentUploads && this.options.limitConcurrentUploads <= this._sending) ? (this.options.limitConcurrentUploads > 1 ? (e = n.Deferred(), this._slots.push(e), h = e.pipe(o)) : (this._sequence = this._sequence.pipe(o, o), h = this._sequence), h.abort = function() {
                return (s = [undefined, "abort", "abort"], !f) ? (e && e.rejectWith(u.context, s), o()) : f.abort()
            }, this._enhancePromise(h)) : o()
        },
        _onAdd: function(t, i) {
            var a = this,
                p = !0,
                ...
                s, e, h, r, y = 0;
            if (c && (!v || u[0].size === undefined) && (c = undefined), (f.singleFileUploads || o || c) && this._isXHRUpload(f))
                if (f.singleFileUploads || c || !o)
                    if (!f.singleFileUploads && c)
                        for (h = [], s = [], r = 0; r < v; r = r + 1) w += u[r].size + b, (r + 1 === v || w + u[r + 1].size + b > c || o && r + 1 - y >= o) && (h.push(u.slice(y, r + 1)), e = l.slice(y, r + 1), e.length || (e = l), s.push(e), y = r + 1, w = 0);
                    else s = l;
            else
                for (h = [], s = [], r = 0; r < v; r += o) h.push(u.slice(r, r + o)), e = l.slice(r, r + o), e.length || (e = l), s.push(e);
            else h = [u], s = [l];
            return i.originalFiles = u, n.each(h || u, function(r, u) {
                var f = n.extend({}, i);
                return f.files = h ? u : [u], f.paramName = s[r], a._initResponseObject(f), a._initProgressObject(f), a._addConvenienceMethods(t, f), p = a._trigger("add", n.Event("add", {
                    delegatedEvent: t
                }), f)
            }), p
        },
        ...
        _handleFileTreeEntry: function(t, i) {
            var s = this,
                ...
                h = function(n) {
                    s._handleFileTreeEntries(n, i + t.name + "/").done(function(n) {
                        r.resolve(n)
                    }).fail(u)
                },
                e = function() {
                ...
                o, f = [];
            return i = i || "", t.isFile ? t._file ? (t._file.relativePath = i, r.resolve(t._file)) : t.file(function(n) {
                n.relativePath = i;
                r.resolve(n)
            }, u) : t.isDirectory ? (o = t.createReader(), e()) : r.resolve([]), r.promise()
        },
        ...
        _getDroppedFiles: function(t) {
            ...
            return i && i.length && (i[0].webkitGetAsEntry || i[0].getAsEntry) ? this._handleFileTreeEntries(n.map(i, function(n) {
                var t;
                return n.webkitGetAsEntry ? (t = n.webkitGetAsEntry(), t && (t._file = n.getAsFile()), t) : n.getAsEntry()
        ...
        _getSingleFileInputFiles: function(t) {
            ...
            if (i = n.makeArray(t.prop("files")), i.length) i[0].name === undefined && i[0].fileName && n.each(i, function(n, t) {
                t.name = t.fileName;
                t.size = t.fileSize
            });
            else {
                if (u = t.prop("value"), !u) return n.Deferred().resolve([]).promise();
                i = [{
                    name: u.replace(/^.*\\/, "")
                }]
            }
        ...
        _onChange: function(t) {
            ...
            this._getFileInputFiles(i.fileInput).always(function(u) {
                ...
                r._trigger("change", n.Event("change", {
                    delegatedEvent: t
                }), i) !== !1 && r._onAdd(t, i)
            })
        },
        _onPaste: function(t) {
            ...
            i && i.length && (n.each(i, function(n, t) {
                var i = t.getAsFile && t.getAsFile();
                i && r.files.push(i)
            }), this._trigger("paste", n.Event("paste", {
                delegatedEvent: t
            }), r) !== !1 && this._onAdd(t, r))
        },
        _onDrop: function(t) {
        ...
        _initEventHandlers: function() {
            ...
            n.support.fileInput && this._on(this.options.fileInput, {
        ...
        _isRegExpOption: function(t, i) {
            return t !== "url" && n.type(i) === "string" && /^\/.*\/[igm]{0,3}$/.test(i)
        },
        _initDataAttributes: function() {
            var t = this,
                r = this.options,
                i = n(this.element[0].cloneNode(!1));
            n.each(i.data(), function(n, u) {
                var f = "data-" + n.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
                i.attr(f) && (t._isRegExpOption(n, u) && (u = t._getRegExp(u)), r[n] = u)
            })
        },
        _create: function() {
            ...
            if (t && !this.options.disabled) {
                if (t.fileInput && !t.files) {
                    ...
                    return u.abort = function() {
                        return (f = !0, r) ? r.abort() : (i.reject(null, "abort", "abort"), u)
                ...
                if (t.files = n.makeArray(t.files), t.files.length) return this._onSend(null, t)
            }
...
var _upliFinishedCallback = function(n) {
    ...
    setGraphicInfo = function() {
        ...
        u != undefined && (n = u.split("/"), t = undefined, artToPosition.clip.parent().data("clipfile") != null ? (t = artToPosition.clip.parent().data("clipfile"), n = artToPosition.clip.parent().parent().data("lUrl") + t) : n = artToPosition.clip.parent().parent().data("lUrl") + n[n.length - 1], _impressionBusy(), graphicGroupElements[0].length == 0 && addGraphicToGroup(0, 0, artToPosition.artType), i = artToPosition.nw, r = artToPosition.nh, rsuAttr(graphicGroupElements[0][0], {
            ...
            _impressionDone()
        }), htmlGraphics[0].src = n, impressionChanged())
    },
